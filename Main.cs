    ...
    public override void Load()
    {
        ...
        try
        {
            RoleHtmlColors = new()
            {
                ...
                { CustomRoles.Bluetooth, "#ff1919" },
                { CustomRoles.Priority, CovenColor },
                { CustomRoles.Degraded,"#b14a0e" },
...
public enum CustomWinner
{
    ...
    Noisebodie = CustomRoles.Noisebodie,
